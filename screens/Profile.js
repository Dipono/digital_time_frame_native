    ...
    const getUserInfo = async () => {
      ...
      for (var i = 0; i < userInfo.length; i++) {
        if (userInfo[i].Email === auth.currentUser.email) {
          ...
          setId(userInfo[i].id);
          setProfileImage(userInfo[i].profile);
          return;
        }
      }
    };
        ...
        uploadTask.on(
          ...
          () => {
            ...
            getDownloadURL(uploadTask.snapshot.ref).then((url) => {
              const updateUserField = doc(userCollectionRef, id);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bottomDiv}>
        ...
        <View style={styles.ContactDiv}>
          ...
          <TouchableOpacity onPress={() => setisModalVisibleContact(true)}>
        ...
        <View style={styles.AboutUsDiv}>
            ...
            <View style={styles.modal}>
              <View style={styles.textView}>
                ...
                <Text style={styles.text}>
                  ...
                  dictum pharetra magna quis tempor. Nunc orci dolor, bibendum
                  id elementum sed, consequat ac nisi. Integer facilisis libero
                  luctus urna rhoncus, sollicitudin tempus leo ornare.
                </Text>
                <TouchableOpacity
                  style={styles.buttonOK}
                  onPress={() =>
          ...
          <TouchableOpacity onPress={() => setisModalVisibleAboutUs(true)}>
...
const styles = StyleSheet.create({
  ...
  AboutUsIcon: {
    ...
    height: 19,
    backgroundColor:
      ": radial-gradient(48.21% 65.62% at 83.93% 16.67%, #FA7B0F 0%, rgba(228, 111, 10, 0.57) 100%)",
    borderRadius: 5,
  },
  AboutUsText: {
    width: 100,
